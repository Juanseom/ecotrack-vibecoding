...
Ejecutado: 2026-09-24T17:28:42.351Z (24/9/2026, 12:28:42 p. m. hora Bogotá)
Servidor sin clave (modo demo): `http://127.0.0.1:3200` · Servidor con clave inválida: `http://127.0.0.1:3201`

**19 de 19 casos pasan · 0 fallan.** Generado por `scripts/test-matrix.mjs`; datos crudos en `test-matrix-results.json`.
